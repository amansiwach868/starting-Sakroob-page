            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="flex lg:flex-row flex-col gap-6">
                    ...
                    <div className="lg:max-w-[740px] w-full">
                        ...
                        <div className="flex max-md:flex-col max-md:gap-[26px] gap-3 justify-between mb-4 mt-[26px]">
                            <Input
                                htmlFor={'city'}
                                labelText={'City'}
                    ...
                    <div className="lg:max-w-[352px] w-full py-[14.5px] px-[14px] shadow-1 rounded-lg bg-white h-full shadow-[0px_0px_11.4px_0px_#73A4E033]">
                        <div>
                            {cartItems.map((item) => (
                                <div key={item.id} className="flex items-center justify-between mb-[26px]">
                                    <div className="flex items-center gap-[9px]">
                                        ...
                                        <p className="font-normal text-[14px] text-[#112D49]">{item.name}</p>
                                    </div>
                                    <p className="font-normal text-[14px] text-[#112D49] text-nowrap">₹ {(item.price * item.quantity).toFixed(2)}</p>
                                </div>
                            ))}

                            <a href="#" className="font-medium text-[13px] text-[#73A4E0]">
                            ...
                            <div className="mt-4 flex flex-row max-[415px]:flex-col gap-[10px] mb-[26px]">
                                <input
                                    ...
                                    className="placeholder:font-normal placeholder:text-base placeholder:text-[#3F566B] py-[5.5px] px-[14px] w-full bg-[#F4F8F7] rounded-full"
                                />
                                <button
                                    type="button"
                                    className="py-2 px-[15px] border border-[#112D49] rounded-full text-base font-medium text-[#112D49] whitespace-nowrap"
                                >
                                    Apply Now
                                </button>
                            </div>
