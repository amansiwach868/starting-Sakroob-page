...
const BlogPage = () => {
    const styles = [
        ...
        'sm:row-start-2 sm:row-end-3 sm:col-start-1 sm:col-end-3 bg-[#D5E8FF]  flex justify-center items-center'
    ];
    ...
    const imgStyles = [
        ...
        'xl:!max-w-[375px] lg:max-w-[300px] max-w-[162px] xl:min-h-[303px] lg:left-[18px] lg:bottom-1/2 lg:translate-y-1/2 max-lg:top-0 max-lg:left-0'
    ];
    ...
    return (
        <div id='blog' className=' max-w-[1440px] w-full mx-auto md:px-7 sm:px-6 px-4 md:my-[132px] sm:my-[100px] my-[75px] flex flex-col justify-center items-center gap-[64px]'>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-x-[26px] gap-y-6 w-full lg:!grid-rows-[335px_388px] sm:grid-rows-[400px_527px] grid-rows-[364px_364px_527px]">
                {BLOG_PAGE_DATA.map((item, i) => (
                    ...
                    >
                        ...
                        />
                        <img
                            className={`${item.active ? 'flex' : 'hidden'} pointer-events-none object-cover w-full lg:rounded-[30px] sm:rounded-[20px] rounded-[10px] absolute xl:!max-w-[365px] lg:max-w-[280px] max-w-[162px] xl:min-h-[303px] lg:right-[27px] lg:bottom-1/2 lg:translate-y-1/2 bottom-0 right-0`}
