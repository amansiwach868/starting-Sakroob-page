...
const FeaturedCategories = () => {
    ...
    const headingStyles = [
        ...
        'max-w-[213px] w-full text-center left-1/2 -translate-x-1/2 top-8',
    ...
    return (
        <div id='featuredCategories' className="max-w-[1440px] md:px-7 sm:px-6 px-4 mx-auto md:my-[132px] sm:my-[100px] my-[70px]">
            <HeadingAndPara
